...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    if ([_delegate respondsToSelector:@selector(didScroll:inFlowView:point:)] )
    {
//        [_delegate didScrollToPage:_currentPageIndex inFlowView:self];
        [_delegate didScroll:_currentPageIndex inFlowView:self point:scrollView.contentOffset];
    }
}

-(void)scrollViewDidEndScrollingAnimation:(UIScrollView *)scrollView
{
    if ([_delegate respondsToSelector:@selector(scrollViewdidend)])
    {
        [_delegate scrollViewdidend];
    }
}
